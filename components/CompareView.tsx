  ...
  const statsRows = useMemo<StatsRow[]>(() => {
    return filteredPlayers.map((player) => {
      ...
      return {
        ...
        pts: getPlayerStat(player, ['projectedPoints', 'projected_points', 'projPoints', 'pointsProjection', 'PTS', 'points']),
        reb: getPlayerStat(player, ['projectedRebounds', 'projected_rebounds', 'projRebounds', 'reboundsProjection', 'REB', 'rebounds']),
        ast: getPlayerStat(player, ['projectedAssists', 'projected_assists', 'projAssists', 'assistsProjection', 'AST', 'assists', 'A']),
